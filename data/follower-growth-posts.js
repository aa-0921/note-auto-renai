...
こっくり系でしっかり潤って、朝起きたらぷるん唇になってる。ストックあと5本ある笑🎀 https://amzn.to/4osgBvj`,
  ...
  {
    title: 'ダルバ ホワイトトリュフ スプレーセラム',
    text: `🎀スプレーセラム使ってみた！

ミストタイプだから満遍なくつけられる。香りが高級化粧品のような気品を感じる香り。

とにかく手軽♥スプレーするだけでトナー+ミスト+セラム+エッセンスをまとめて一度にケアできる！メイクの上から使っても邪魔をしないので、日中の保湿ケアにもおすすめ🎀 https://amzn.to/4qOThcV`,
    image: ''
  },
  {
...
とにかく肌にはりを与えてぷるぷるの質感にしてくれるコラーゲンマスク！

ゼリーのような質感で液ダレしないマスクが特徴。とにかく保湿をしてくれて肌の角層をコラーゲンや保湿成分で埋めてくれる♡
...
話題の「毛穴が開いているほどピリピリする」シートマスク！

ナンバーズイン公式の調査では毛穴の開きが39％改善されるというデータもあるらしい、毛穴の超特化型マスク♡

発酵成分がたっぷり配合されていて、お肌のキメもしっかり整えてくれる🎀 https://amzn.to/4oUQVHC`,
    image: ''
  },
  {
