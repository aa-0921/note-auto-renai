...
(async () => {
  await runWithCore(async ({ core, wantsBackground }) => {
    ...
    // ※ブラックフライデーセールが12/1(月)までであることをタイトルにも明記
    const titleCandidates = [
      '🉐 【12/1(月)まで】Amazonブラックフライデーセール商品情報一覧　カテゴリ別まとめ',
      '🎁 【12/1(月)まで】Amazonブラックフライデーセール商品情報一覧　カテゴリ毎にチェック',
      '📝 【12/1(月)まで】Amazonブラックフライデーセール商品情報一覧　カテゴリ別お得情報',
      '✨ 【12/1(月)まで】Amazonブラックフライデーセール商品情報一覧　カテゴリ毎リンク集',
      '🛍️ 【12/1(月)まで】Amazonブラックフライデーセール商品情報一覧　カテゴリ別セール情報',
      '💰 【12/1(月)まで】Amazonブラックフライデーセール商品情報一覧　カテゴリ毎お得商品',
    ];
    ...
    const closing = [
      ...
      'ブラックフライデーセールは12/1(月)までなので、気になる商品があればお早めにチェックしてみてください⏰',
