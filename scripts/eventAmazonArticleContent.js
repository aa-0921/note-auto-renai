...
export const eventAmazonArticleTitles = [
  '🎉 【12/8(月)まで】アマゾンブラックフライデー（アフターセール）セール開催中！お得な商品をチェック',
  '🛍️ 【12/8(月)まで】アマゾンブラックフライデー（アフターセール）セール情報をお届けします！',
  '💰 【12/8(月)まで】今だけの特別価格！お見逃しなく！ブラックフライデー（アフターセール）セール',
  '✨ 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セール情報まとめ',
  '🎁 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セールお得な情報をお届けします',
  '🔥 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セールでお買い物！',
  '💸 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セールセール情報',
  '🎊 【12/8(月)まで】Amazonブラックフライデー（アフターセール）セール開催！要チェック商品まとめ',
];
