...
// ※ブラックフライデー／節約／ストックなど投稿内容と関連するフレーズのみを置く
//   すべて「セールは12/1(月)まで[内容に合う絵文字]〜」の形式に統一
export const saleTweetPrefixVariations = [
  ...
  'セールは12/1(月)まで🧻日用品の買い時🧽',
  'セールは12/1(月)まで😉迷ってた物のチャンス🌀',
  'セールは12/1(月)まで💡どうせ買うなら今🛒',
  'セールは12/1(月)まで📉固定費を下げたい人向け💡',
  'セールは12/1(月)まで🎁ご褒美も節約も両立したい人へ💝',
  'セールは12/1(月)まで🌟今年買ってよかった物を補充🧴',
  'セールは12/1(月)まで🙌来月を楽にする買い方📆',
  'セールは12/1(月)まで🏠生活の質を上げたい人へ🛋️',
  'セールは12/1(月)まで👓ブラックフライデー活用術📌',
  'セールは12/1(月)まで😊我慢してた人向けのセール💬',
  'セールは12/1(月)まで🎯必要な物だけ狙う派向け🧠',
  'セールは12/1(月)まで🧺カゴの中を見直すタイミング♻️',
  'セールは12/1(月)まで🔁買い替え検討中の人へ🆕',
  'セールは12/1(月)まで📦いつもの定番を安く仕入れる日🧃',
  'セールは12/1(月)まで📅年末前のまとめ買い計画🧾',
];
