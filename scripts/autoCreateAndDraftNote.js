...
// Audible・Kindleアフィリエイト設定（エクスポート用）
...
export const affiliateConfig = {
  ...
  kindleAffiliateEnabled,
    ...
    // ----------------------------------------------------------------------------------
    // 複数のアフィリエイトリンクを定義
// 商品アフィリエイトリンク（エクスポート用）
export const productAffiliateLinks = [
  [
    '',
    '📚　💝　📚　💝　📚　💝　📚　💝　📚　💝　📚　💝　📚　💝　📚',
    'https://amzn.to/4goaSUk',
...
(async () => {
  await runWithCore(async ({ core, wantsBackground }) => {
    ...
    // ----------------------------------------------------------------------------------
    // アフィリエイトリンクと設定はトップレベルの変数を参照
    const affiliateLinks = productAffiliateLinks;
    // ※ affiliateTag, audibleAffiliateEnabled, kindleAffiliateEnabled は
    //    トップレベルで定義済み (affiliateConfig 経由でもアクセス可能)
